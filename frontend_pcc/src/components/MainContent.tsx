...
import TerminalConfigView from './pos/TerminalConfigView';
...
export default function MainContent({ activeView, onClose }: MainContentProps) {
  const renderView = () => {
    switch (activeView) {
      ...
      case 'pos_terminals': return <TerminalConfigView />;
      ...
      case 'hr_collaborators': return <div className="p-4">Gestão de Colaboradores (Em Desenvolvimento)</div>;
      case 'hr_pos_operators': return <div className="p-4">Operadores POS (Em Desenvolvimento)</div>;
      case 'hr_shifts': return <div className="p-4">Gestão de Turnos (Em Desenvolvimento)</div>;
      case 'hr_departments': return <div className="p-4">Departamentos & Áreas (Em Desenvolvimento)</div>;
