...
export default function Launchpad() {
  ...
  return (
    <div className="min-h-screen bg-[#eef1f5] font-sans">
      <div className="h-14 bg-[#B08D3C] flex items-center px-5 text-white">
          ...
          {modules.map((mod) => {
            ...
            return (
              <button key={mod.key} onClick={() => open(mod)}
                className="bg-white border border-[#d5dbe3] rounded-lg p-4 text-left shadow-sm hover:shadow-md hover:border-[#B08D3C] transition group">
                <div className="text-[#B08D3C] mb-2"><Ico size={30} strokeWidth={1.8} /></div>
                <div className="font-bold text-[#B08D3C] text-sm leading-tight group-hover:underline">{mod.title}</div>
