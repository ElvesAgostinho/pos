...
export default function Launchpad() {
  ...
  return (
    <div className="min-h-screen bg-[#eef1f5] font-sans">
      <div className="h-14 bg-[#336699] flex items-center px-5 text-white">
          ...
          {modules.map((mod) => {
            ...
            return (
              <button key={mod.key} onClick={() => open(mod)}
                className="bg-white border border-[#d5dbe3] rounded-lg p-4 text-left shadow-sm hover:shadow-md hover:border-[#336699] transition group">
                <div className="text-[#336699] mb-2"><Ico size={30} strokeWidth={1.8} /></div>
                <div className="font-bold text-[#336699] text-sm leading-tight group-hover:underline">{mod.title}</div>
