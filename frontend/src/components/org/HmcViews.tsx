...
export function HmcDashboardView() {
  ...
  const Card = ({ label, value }: any) => (
    <div className="bg-white border border-[#a0a0a0] p-3"><div className="text-[10px] text-gray-500 uppercase">{label}</div><div className="text-2xl font-bold text-[#B08D3C]">{value ?? '—'}</div></div>
  );
  return (
