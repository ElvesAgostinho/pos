        ...
        <div className="flex-1 overflow-hidden">
          <ClassicGrid
            ...
            columns={[
              ...
              { header: '', accessor: (r: any) => r.status === 'DRAFT' ? <button title="Confirmar" onClick={() => doConfirm(r.id)} className="text-[#062A31] hover:text-[#062A31]"><Check size={13} /></button> : null, width: '8%' },
            ]}
          />
        </div>
      </div>
