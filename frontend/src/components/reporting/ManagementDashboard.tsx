...
function Card({ icon: Icon, label, value, color, sub }: { icon: any; label: string; value: string; color: string; sub?: string }) {
  return (
    <div className="bg-white border border-[#c0c0c0] shadow-[inset_1px_1px_0_#fff] p-3 flex items-center gap-3 min-w-[190px]">
      ...
      <div><div className="text-[10px] uppercase tracking-wide text-gray-500">{label}</div><div className="text-xl font-bold text-[#336699]">{value}</div>{sub && <div className="text-[10px] text-gray-500">{sub}</div>}</div>
    </div>
  );
}
  ...
  return (
    <ClassicWindow title="Dashboard de Gestão (Reporting)" icon={<TrendingUp size={14} className="text-gray-300" />}
      ...
      <div className="p-4 space-y-4 bg-[#ececec] h-full overflow-auto">
        <div>
          <div className="text-[11px] font-bold text-[#336699] mb-2 uppercase">Vendas & Margem (hoje)</div>
        ...
        <div>
          <div className="text-[11px] font-bold text-[#336699] mb-2 uppercase">Stock</div>
          <div className="flex flex-wrap gap-2">
        ...
        <div>
          <div className="text-[11px] font-bold text-[#336699] mb-2 uppercase">Financeiro</div>
          <div className="flex flex-wrap gap-2">
        ...
        <div>
          <div className="text-[11px] font-bold text-[#336699] mb-2 uppercase">Hotelaria (PMS)</div>
          <div className="flex flex-wrap gap-2">
        ...
        {pos.top_products?.length ? (
          <div>
            <div className="text-[11px] font-bold text-[#336699] mb-1 uppercase">Mais vendidos (hoje)</div>
