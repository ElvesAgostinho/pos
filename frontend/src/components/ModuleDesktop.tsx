    ...
    <div className="h-screen w-screen flex flex-col overflow-hidden">
      ...
      <div className="h-9 bg-[#c0c0c0] flex items-center px-1 gap-1 flex-shrink-0 relative"
        ...
        <button onClick={() => setStartOpen((o) => !o)}
          ...
          <span className="text-sm font-black leading-none"><span className="text-[#c9a400]">M</span><span className="text-[#B08D3C]">L</span></span> Iniciar
        </button>
        ...
        {startOpen && (
          <div className="absolute left-1 bottom-9 w-64 bg-[#c0c0c0] py-1 z-40" onMouseLeave={() => setStartOpen(false)}
            ...
            <div className="flex">
              <div className="w-7 bg-[#B08D3C] flex items-end justify-center pb-2">
  ...
  return (
    <div className="h-full w-full flex items-center justify-center p-6">
      <div className="bg-white border border-[#c0c0c0] p-8 max-w-lg text-center shadow">
        <div className="w-14 h-14 mx-auto mb-4 bg-[#f0f0f0] border border-[#c0c0c0] rounded-full flex items-center justify-center"><Construction size={26} className="text-[#B08D3C]" /></div>
